...
class TixSettings:
    ...
    def __init__(self, root):
        ...
        self.gd1_check = tk.Checkbutton(self.root, text="Glinda Day 1", variable=self.gd1_value, onvalue=1, offvalue=0, relief="ridge", bg="#798ec4", activebackground="#798ec4", fg="#151c4c", activeforeground="#151c4c", disabledforeground="#d9e2f1")
        self.gd1_check.config(width=12, font=("Helvetica", 10, "bold"))
        self.gd1_check.place(x=668, y=275)

        self.gd2_value = tk.IntVar()
        self.gd2_check = tk.Checkbutton(self.root, text="Glinda Day 2", variable=self.gd2_value, onvalue=1, offvalue=0, relief="ridge", bg="#798ec4", activebackground="#798ec4", fg="#151c4c", activeforeground="#151c4c", disabledforeground="#d9e2f1")
        self.gd2_check.config(width=12, font=("Helvetica", 10, "bold"))
        self.gd2_check.place(x=668, y=315)

        self.ed1_value = tk.IntVar()
        self.ed1_check = tk.Checkbutton(self.root, text="Elphaba Day 1", variable=self.ed1_value, onvalue=1, offvalue=0, relief="ridge", bg="#798ec4", activebackground="#798ec4", fg="#151c4c", activeforeground="#151c4c", disabledforeground="#d9e2f1")
        self.ed1_check.config(width=12, font=("Helvetica", 10, "bold"))
        self.ed1_check.place(x=823, y=275)

        self.ed2_value = tk.IntVar()
        self.ed2_check = tk.Checkbutton(self.root, text="Elphaba Day 2", variable=self.ed2_value, onvalue=1, offvalue=0, relief="ridge", bg="#798ec4", activebackground="#798ec4", fg="#151c4c", activeforeground="#151c4c", disabledforeground="#d9e2f1")
    ...
    def check_sold_out(self):
        if self.glinda_day_one_seats.get() == 43:
            ...
            self.gd1_check.config(state="disabled")
        else:
            self.gd1_check.deselect()
            self.gd1_check.config(state="normal")

        if self.glinda_day_two_seats.get() == 43:
            self.gd2_check.select()
            self.gd2_check.config(state="disabled")
        else:
            self.gd2_check.deselect()
            self.gd2_check.config(state="normal")

        if self.elphaba_day_one_seats.get() == 43:
            self.ed1_check.select()
            self.ed1_check.config(state="disabled")
        else:
            self.ed1_check.deselect()
            self.ed1_check.config(state="normal")

        if self.elphaba_day_two_seats.get() == 43:
            self.ed2_check.select()
            self.ed2_check.config(state="disabled")
        else:
            self.ed2_check.deselect()
            self.ed2_check.config(state="normal")
