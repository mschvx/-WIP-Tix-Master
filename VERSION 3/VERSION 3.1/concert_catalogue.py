...
class ConcertCatalogue:
    ...
    def __init__(self, root):
        ...
        self.glinda_day_one_button = tk.Button(self.root, image=self.glinda_day_one, relief="raised", command=lambda: self.open_loading(self.queue_num_gd1))
        ...
        self.glinda_day_two_button = tk.Button(self.root, image=self.glinda_day_two, relief="raised", command=lambda: self.open_loading(self.queue_num_gd2))
        ...
        self.elphaba_day_one_button = tk.Button(self.root, image=self.elphaba_day_one, relief="raised", command=lambda: self.open_loading(self.queue_num_ed1))
        ...
        self.elphaba_day_two_button = tk.Button(self.root, image=self.elphaba_day_two, relief="raised", command=lambda: self.open_loading(self.queue_num_ed2))
    ...
    def open_loading(self, queue_number):
        ...
        TixLoading(self.root, queue_number)
