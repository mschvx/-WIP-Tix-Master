...
class TixMaster:
    ...
    def __init__(self, root):
        ...
        self.main_title = tk.PhotoImage(file="Designs/Main/Main_Title.png")
        ...
        self.start = tk.PhotoImage(file="Designs/Main/Start_Button.png")
        ...
        self.start_hover = tk.PhotoImage(file="Designs/Main/Start_Button_Hover.png")
        ...
        self.exit = tk.PhotoImage(file="Designs/Main/Exit_Button.png")
        ...
        self.exit_hover = tk.PhotoImage(file="Designs/Main/Exit_Button_Hover.png")
        ...
        self.settings = tk.PhotoImage(file="Designs/Main/Settings_Button.png")
        ...
        self.settings_hover = tk.PhotoImage(file="Designs/Main/Settings_Button_Hover.png")
