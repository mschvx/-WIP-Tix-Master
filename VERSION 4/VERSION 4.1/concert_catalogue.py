...
class ConcertCatalogue:
    ...
    def __init__(self, root):
        ...
        self.selected_concert = None  # property to keep track of the selected concert
        ...
        self.glinda_day_one_button = tk.Button(self.root, image=self.glinda_day_one, relief="raised", command=lambda: self.select_concert("Glinda Day 1", self.queue_num_gd1))
        ...
        self.glinda_day_two_button = tk.Button(self.root, image=self.glinda_day_two, relief="raised", command=lambda: self.select_concert("Glinda Day 2", self.queue_num_gd2))
        ...
        self.elphaba_day_one_button = tk.Button(self.root, image=self.elphaba_day_one, relief="raised", command=lambda: self.select_concert("Elphaba Day 1", self.queue_num_ed1))
        ...
        self.elphaba_day_two_button = tk.Button(self.root, image=self.elphaba_day_two, relief="raised", command=lambda: self.select_concert("Elphaba Day 2", self.queue_num_ed2))
    ...
    def open_loading(self, queue_number):
        from tix_loading import TixLoading
        self.catalogue_title_label.place_forget()
        TixLoading(self.root, queue_number, self.selected_concert)  
        ...
        with open("simulation_settings.dat", "r") as loadSettings:
            ...
            for num, line in enumerate(load):
                ...
                if num == 0:
                    ...
                    self.queue_num_gd1 = int(line.split(':')[1])
                elif num == 5:
                    self.queue_num_gd2 = int(line.split(':')[1])
                elif num == 6:
                    self.queue_num_ed1 = int(line.split(':')[1])
                elif num == 7:
                    self.queue_num_ed2 = int(line.split(':')[1])
    ...
    def select_concert(self, concert_name, queue_number):
        self.selected_concert = concert_name
        self.open_loading(queue_number)
