...
class TixCart:
    ...
    def __init__(self, root):
        ...
        self.r1_button = tk.Button(self.root, image=self.r1, relief="raised")
        ...
        self.r2_button = tk.Button(self.root, image=self.r2, relief="raised")
        ...
        self.r3_button = tk.Button(self.root, image=self.r2, relief="raised")
    ...
    def load_cart(self):
        ...
        self.item_one_label.config(text=item_one)
        self.price_one_label.config(text=f"₱{price_one}")
        self.item_two_label.config(text=item_two)
        self.price_two_label.config(text=f"₱{price_two}")
        self.item_three_label.config(text=item_three)
        self.price_three_label.config(text=f"₱{price_three}")
