...
class TixSettings:
    ...
    def __init__(self, root):
        ...
        self.save_button.place(x=720, y=425, anchor="center")
        ...
        self.back_button.place(x=895, y=425, anchor="center")
    ...
    def check_sold_out(self):
        ...
        if self.glinda_day_one_seats.get() == 40:
            self.gd1_check.select()
        else:
            self.gd1_check.deselect()

        if self.glinda_day_two_seats.get() == 40:
            self.gd2_check.select()
        else:
            self.gd2_check.deselect()

        if self.elphaba_day_one_seats.get() == 40:
            self.ed1_check.select()
        else:
            self.ed1_check.deselect()

        if self.elphaba_day_two_seats.get() == 40:
